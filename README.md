...
```csharp
[Monify(Type = typeof(int), DebuggerDisplay = false)]
public partial struct Age;
```

Passthrough interfaces, methods, and properties are generated by default. Set `Passthrough = false` to disable them for a type:
...
```csharp
[Monify(Type = typeof(int), Passthrough = false)]
public partial struct Age;
```
