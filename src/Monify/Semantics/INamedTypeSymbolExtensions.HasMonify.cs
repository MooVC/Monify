    ...
    internal static partial class INamedTypeSymbolExtensions
    {
        ...
        public static bool HasMonify(this INamedTypeSymbol subject, SemanticModel model, out ITypeSymbol value, out bool debuggerDisplay, out bool passthrough)
        {
            AttributeData data = subject
                .GetAttributes()
                .Where(attribute => attribute.AttributeClass is object && attribute.AttributeClass.IsMonify())
        ...
        private static bool GetTypeFromArgumentSyntax(AttributeData attribute, SemanticModel model, ref ITypeSymbol value)
        {
            ...
            if (syntax is null || syntax.ArgumentList is null)
            {
                return false;
            }
            ...
            var typeOfSyntax = type?.Expression as TypeOfExpressionSyntax;

            if (typeOfSyntax is null)
            {
                return false;
            }
