namespace Monify.Semantics
{
    ...
    internal static partial class INamedTypeSymbolExtensions
    {
        ...
        private static bool CanForwardForSpecialType(this INamedTypeSymbol @interface, INamedTypeSymbol value, INamedTypeSymbol comparable, INamedTypeSymbol comparableGeneric)
        {
        ...
        {
            return comparableGeneric is object
