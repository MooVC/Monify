namespace Monify
{
        ...
        : DiagnosticAnalyzer
    {
        ...
        /// </value>
        internal static DiagnosticDescriptor CapturesStateRule { get; } = new DiagnosticDescriptor(
            "MONFY03",
        ...
        /// </value>
        internal static DiagnosticDescriptor SelfReferenceRule { get; } = new DiagnosticDescriptor(
            "MONFY04",
        ...
        {
            return new LocalizableResourceString(name, manager, typeof(AttributeAnalyzer_Resources));
        }
